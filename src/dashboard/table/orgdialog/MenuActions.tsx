...
export class MenuActions extends React.Component<
    MenuActionsProps,
    MenuActionState
> {
    ...
    handleChangeState(event: any, state: OrgStatus) {
        event.stopPropagation();
        this.props.onStatusAffectation(
            this.props.org,
            state,
            this.props.idUser as number
        );
        this.setState({
            ...this.state,
            anchorEl: undefined,
    ...
    render(): JSX.Element {
        ...
        return (
            <div className="menuactions">
                ...
                >
                    <MenuItem
                        disabled={!this.props.isAffected}
                    ...
                    <MenuItem
                        ...
                        onClick={(event) => {
                            const handleAffectation =
                                this.handleAffectation.bind(this);
