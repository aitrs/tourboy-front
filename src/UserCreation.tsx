...
export class UserCreation extends React.Component<{}, UserCreationState> {
    ...
    render(): JSX.Element {
        const body: JSX.Element = this.state.newId === undefined ?
                ...
                <Card>
                    ...
                    <CardContent>
                        <TextField
                            ...
                            onChange={(ev) => {this.changeValue('pseudo', ev)}}
                        ...
                        <TextField
                            ...
                            onChange={(ev) => {this.changeValue('name', ev)}}
                            onBlur={this.onBlur.bind(this)}
                        />
                        <br />    
                        <br />
                        <TextField
                            ...
                            onChange={(ev) => {this.changeValue('firstname', ev)}}
                            onBlur={this.onBlur.bind(this)}
                        />
                        <br />
                        <br />
                        <TextField
                            ...
                            onChange={(ev) => {this.changeValue('email', ev)}}
                            onBlur={this.onBlur.bind(this)}
                        />
                        <br />
                        <br />
                        <TextField
                            ...
                            onChange={(ev) => {this.changeValue('pwd', ev)}}
                            onBlur={this.onBlur.bind(this)}
                        />
                    </CardContent>
                    <CardActions>
            ...
            <Card>
                <CardContent>
                    <p>
                        Utilisateur créé avec succès avec l'ID {this.state.newId}
                    </p>
                    <p>
                        Un email de vérification vous a été envoyé sur votre adresse email.
                    </p>
                </CardContent>
            </Card>;
        return body;
